...
import { Form, Button, Col, Row } from 'bootstrap-4-react';
...
try {
    ...
    let lastId = parseInt(listUsers.data.length) + 1
...
<br />
<h4>Tarefas registradas! Tente concluí-las antes do prazo!</h4>
<ol>
...
<b>Vencimento:</b> {item.vencimento} <br /> 
